...
|-----------|---------|---------------|-------|
| **Screen (front display)** | V 0.9.1 | [Download]([https://github.com/Biohazard86/SWAP-CAN-VOODOO-BIN/releases/latest/download/screen.bin](https://github.com/Biohazard86/SWAP-CAN-VOODOO-BIN/blob/main/releases/BACK%20PCB%20BIN/BACK_PCB_Swap-Can-VOODOO-V0.9.1.bin)) | Display unit on the front (use left USB-C) |
| **Back (white PCB)** | V 0.9.1 | [Download](https://github.com/Biohazard86/SWAP-CAN-VOODOO-BIN/releases/BACK PCB BIN/BACK_PCB_Swap-Can-VOODOO-V0.9.1.bin) | ECU communication board on the back of the gauge |
